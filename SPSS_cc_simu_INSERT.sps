...
***************************************************************************
    ...
    *** In example data:           n = 300, samples = 500, m+2 = 20 (18 variables).
...
compute samples = $INSERT_samples.
...
INPUT PROGRAM.
    ...
    LOOP #1 = 1 to n_pop.
        DO REPEAT z = z1 to z$INSERT_m+2.
            COMPUTE z = NORMAL(1).
        END REPEAT.
        END CASE.
    END LOOP.
...
FACTOR /VARIABLES ALL
    ...
    /CRITERIA FACTORS($INSERT_m+2) ITERATE(500)
    /EXTRACTION PC
    /ROTATION NOROTATE
    /SAVE REG(ALL x)
    /METHOD=CORRELATION.
...
delete variables z1 to z$INSERT_m+2.
